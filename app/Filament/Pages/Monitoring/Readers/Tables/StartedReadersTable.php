...
class StartedReadersTable extends Component implements HasTable, HasForms
{
    ...
    {
        return view('filament.pages.monitoring.readers.tables.started-readers-table');
    }
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ->query(User::query()
                ...
                ->where('book_user_states.status', BookUserStatus::STARTED)
                ->where(function ($query) {
                    $query->where('book_chapter_user_states.status', BookUserStatus::STARTED)
